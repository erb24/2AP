...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       ...
       INTEGER :: i, j, k, t, skip, residue, ios, nLines, nResidues, Time
...
! Allocate atoms array
       ...
       DO t=1,Time
              ...
              DO residue=1,nResidues
                     ...
                     READ(1,'(A)')line
                     READ(line(23:29),'(F13.9)')atoms(residue, 1, 1)
                     READ(line(31:37),'(F13.9)')atoms(residue, 1, 2)
                     READ(line(39:45),'(F13.9)')atoms(residue, 1, 3)

                     ! Get the XYZ cartesian coordinates for site 2 atom
                     READ(1,'(A)')line
                     READ(line(23:29),'(F13.9)')atoms(residue, 2, 1)
                     READ(line(31:37),'(F13.9)')atoms(residue, 2, 2)
                     READ(line(39:45),'(F13.9)')atoms(residue, 2, 3)

                     ! Get the XYZ cartesian coordinates for site 3 atom
                     READ(1,'(A)')line
                     READ(line(23:29),'(F13.9)')atoms(residue, 3, 1)
                     READ(line(31:37),'(F13.9)')atoms(residue, 3, 2)
                     READ(line(39:45),'(F13.9)')atoms(residue, 3, 3)

                     ! Get the XYZ cartesian coordinates for site 4 atom
                     READ(1,'(A)')line
                     READ(line(23:29),'(F13.9)')atoms(residue, 4, 1)
                     READ(line(31:37),'(F13.9)')atoms(residue, 4, 2)
                     READ(line(39:45),'(F13.9)')atoms(residue, 4, 3)

                     ! Get the XYZ cartesian coordinates for site 5 atom
                     READ(1,'(A)')line
                     READ(line(23:29),'(F13.9)')atoms(residue, 5, 1)
                     READ(line(31:37),'(F13.9)')atoms(residue, 5, 2)
                     READ(line(39:45),'(F13.9)')atoms(residue, 5, 3)

                     ! Get the XYZ cartesian coordinates for site 6 atom
                     READ(1,'(A)')line
                     READ(line(23:29),'(F13.9)')atoms(residue, 6, 1)
                     READ(line(31:37),'(F13.9)')atoms(residue, 6, 2)
                     READ(line(39:45),'(F13.9)')atoms(residue, 6, 3)

                     ! Get the XYZ cartesian coordinates for site 4 atom
                     READ(1,'(A)')line
                     READ(line(23:29),'(F13.9)')atoms(residue, 7, 1)
                     READ(line(31:37),'(F13.9)')atoms(residue, 7, 2)
                     READ(line(39:45),'(F13.9)')atoms(residue, 7, 3)

                     ! Get the XYZ cartesian coordinates for site 2 atom
                     READ(1,'(A)')line
                     READ(line(23:29),'(F13.9)')atoms(residue, 8, 1)
                     READ(line(31:37),'(F13.9)')atoms(residue, 8, 2)
                     READ(line(39:45),'(F13.9)')atoms(residue, 8, 3)
              END DO
